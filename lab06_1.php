...
.info{width:800px; color:#006; background:#6FC; margin:0 auto}
</style>
</head>
...
<table  align="center">
	...
	<tr>
		<td>Thông tin:</td>
		<td>
			<textarea name="thong_tin" rows="4" cols="30"></textarea>
		</td>
	</tr>
    	...
    	<?php 
			if ($err !="") echo $err;
			else
			  {
				...
				echo "Mật khẩu đã mã hóa Md5 và sha1:".md5($password1) .sha1($password1) ."<br>";
				echo "Họ tên: ". ucwords($name) ."<br>";  
				echo "thong tin:.$thong_tin <br>";
			}
		?>
    </div>
    <?php
